...
trytes = math.ceil(len(tstring)/2187)*2673
...
plt.bar(X + 0.00, data[0], color = 'b', width = 0.25, label="Update size 5")
plt.bar(X + 0.25, data[1], color = 'g', width = 0.25, label="Update size 15")
plt.bar(X + 0.50, data[2], color = 'r', width = 0.25, label="Update size 25")
...
# naming the y axis 2
plt.xlabel('Number of updates/messages posted') 
plt.legend()
plt.show()
